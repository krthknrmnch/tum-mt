 ...
 * We make use of this database to manage secondary repository collections.
 */
@Configuration
@EnableMongoRepositories(basePackages = "com.tum.in.cm.platformservice.repository.secondary", mongoTemplateRef = "secondaryMongoTemplate")
