package com.tum.in.cm.connectorservice.config.db;
 ...
 */
@Configuration
@EnableMongoRepositories(basePackages = "com.tum.in.cm.connectorservice.repository.primary", mongoTemplateRef = "primaryMongoTemplate")
